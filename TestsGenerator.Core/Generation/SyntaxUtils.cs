...
internal static class SyntaxUtils
{
        ...
        IEnumerable<string> sourceNamespacesNames)
    {
        ...
        var namespacesNames = sourceNamespacesNames as string[] ?? sourceNamespacesNames.ToArray();
        NameSyntax name = namespacesNames.Last() != string.Empty
            ? QualifiedName(
                IdentifierName(namespacesNames.First()),
